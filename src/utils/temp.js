    ...
    static notiinfo =
        {
            ...
            userId: 1,
            status: 'READ',
            content: 'Interpreters đã xác nhận đơn booking của bạn',
        }
    static KOLDEtail = {
        firstname: 'Gấmmm',
        lastname: 'Gấmmm',
    ...
    static dataMes = [
        {
            id: 1,
            userSend: true,
            content: 'Xin chào! Tôi đang tìm một Interpreters để quảng cáo sản phẩm của tôi. Bạn có thể giới thiệu cho tôi một số lựa chọn phù hợp không? '
        },
        {
            id: 2,
            userSend: false,
        ...
        },
        {
            id: 3,
            userSend: true,
            content: 'Sản phẩm của tôi là một dòng mỹ phẩm tự nhiên và chúng tôi muốn tạo sự nhận diện thương hiệu mạnh mẽ. Mục tiêu của chúng tôi là tiếp cận một đối tượng khách hàng trẻ tuổi thông qua mạng xã hội. Bạn có thể giới thiệu cho tôi một Interpreters có đối tượng khán giả tương tự không?'
        },
        {
            id: 4,
            userSend: true,
        ...
        },
        {
            id: 5,
            userSend: false,
            content: 'Rất tốt! Xin hãy làm như vậy. Bạn có thể cho tôi biết về mức giá dự kiến và thời gian tiếp cận của Interpreters này không?'
        },
        {
            id: 6,
            userSend: false,
